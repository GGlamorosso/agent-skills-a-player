...
| [`conversion-copy-design`](skills/conversion-copy-design/) | Conçoit ou audite des pages anti-slop et réutilise obligatoirement `shopify-section-kit` avant de coder sur Shopify | « redesign la page », « refais le hero », « améliore la conversion » |
...
- `conversion-copy-design` : fonctionne en conseil, audit ou production HTML/CSS/Liquid. Sur Shopify, il impose une recherche documentée dans [`shopify-section-kit`](https://github.com/GGlamorosso/shopify-section-kit), la réutilisation d'une variante existante quand elle convient, puis `check.py --theme` avant livraison.
